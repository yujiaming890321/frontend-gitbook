...
spike [spaɪk] n.尖峰;尖状物; v.用尖物刺入 （ 调研 ）
...
nest [nest] n.筑巢;巢居;嵌套(信息)
leasing [ˈliːsɪŋ] v.租用，租借，出租
lending [ˈlendɪŋ] n.放款;贷放 v.借给;借出;
...
hunk [hʌŋk] n.大块，大片; 帅哥;
denied [dɪˈnaɪd] v. 否认;否定;拒绝承认;拒绝接受;拒绝;拒绝给予
intern [ˈɪntɜːrn] n.实习
